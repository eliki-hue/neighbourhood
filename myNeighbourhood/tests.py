...
class ProfileTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.user.save()
        self.user_profile = Profile(user=self.user, profile_image="myimage.jpg", bio="My bio")
    ...
    def test_members_count(cls):
        count =NeighbourHood.members_count()
        cls.assertTrue(count==1)
...
class BusinessTestClass(TestCase):
    ...
    def setUp(self):
        ...
        self.hood= NeighbourHood(hood_name="kabatini",hood_location="Nairobi",occupants_count=10,admin=self.user_profile)
        self.hood.save()
